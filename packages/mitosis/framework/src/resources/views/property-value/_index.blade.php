@foreach($propertyValues as $propertyValue)
    <div class="btn-group btn-group-sm mb-1" role="group">
        @can('edit propertyvalues')
            <a href="{{ route('mitosis.property_value.edit', [$property, $propertyValue]) }}"
        ...
        <div class="dropdown-menu">
            @can('delete propertyvalues')
                {{ Form::open([
                            'url' => route('mitosis.property_value.destroy', [$property, $propertyValue]),
...
@can('create propertyvalues')
    <a href="{{ route('mitosis.property_value.create', $property) }}"
