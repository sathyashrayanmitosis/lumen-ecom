...
<div id="properties-assign-to-model-modal" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            {!! Form::open([
                    'url'  => route('mitosis.property_value.sync', [$for, $forId]),
                    'method' => 'PUT'
                ])
            !!}
...
@include('mitosis::property-value.assign._create_property_value')
    ...
    new Vue({
        ...
        methods: {
            ...
            onPropertyValueChange(event, propertyId) {
                ...
                var url = "{{ route('mitosis.property_value.create', '@@@') }}";
