        ...
        <div class="card-header">
            ...
            <div class="card-actionbar">
                @can('create taxonomies')
                    <a href="{{ route('mitosis.taxonomy.create') }}" class="btn btn-sm btn-outline-success float-right">
                ...
                @foreach($taxonomies as $taxonomy)
                    <tr>
                        <td>
                            ...
                            @can('view taxonomies')
                                <a href="{{ route('mitosis.taxonomy.show', $taxonomy) }}">{{ $taxonomy->name }}</a>
                            @else
                                {{ $taxonomy->name }}
                            @endcan
                            </span>
                        ...
                        <td>
                            @can('edit taxonomies')
                                <a href="{{ route('mitosis.taxonomy.edit', $taxonomy) }}"
                                   class="btn btn-xs btn-outline-primary btn-show-on-tr-hover float-right">{{ __('Edit') }}</a>
                            @endcan

                            @can('delete taxonomies')
                                {{ Form::open([
                                    'url' => route('mitosis.taxonomy.destroy', $taxonomy),
