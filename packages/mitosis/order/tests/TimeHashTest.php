...
use Carbon\Carbon;
use Mitosis\Order\Generators\TimeHashGenerator;
...
class TimeHashTest extends TestCase
{
    ...
    public function can_be_configured_to_return_numbers_in_uppercase()
    {
        ...
        config(['mitosis.order.number.time_hash.uppercase' => true]);
    ...
    {
        config(['mitosis.order.number.time_hash.start_base_date' => '2013-11-27']);
        // Generate a new one to reread configuration
        $this->generator = new TimeHashGenerator();
