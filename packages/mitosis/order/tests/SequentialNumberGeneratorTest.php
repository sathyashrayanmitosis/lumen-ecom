...
use Mitosis\Order\Generators\SequentialNumberGenerator;
...
class SequentialNumberGeneratorTest extends TestCase
{
    ...
    {
        config(['mitosis.order.number.sequential_number.prefix' => 'PO']);
    ...
    {
        config(['mitosis.order.number.sequential_number.pad_length' => 4]);
    ...
    {
        config(['mitosis.order.number.sequential_number.pad_length' => 4]);
        config(['mitosis.order.number.sequential_number.pad_string' => 'X']);
    ...
    {
        config(['mitosis.order.number.sequential_number.start_sequence_from' => 10000]);
    ...
    {
        config(['mitosis.order.number.sequential_number.start_sequence_from' => 1000]);
    ...
    {
        config(['mitosis.order.number.sequential_number.prefix' => $prefix]);
        config(['mitosis.order.number.sequential_number.start_sequence_from' => $start]);
        config(['mitosis.order.number.sequential_number.pad_length' => $padLen]);
        config(['mitosis.order.number.sequential_number.pad_string' => $padStr]);
