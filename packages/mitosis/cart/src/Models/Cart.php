...
class Cart extends Model implements CartContract
{
    ...
    const EXTRA_PRODUCT_MERGE_ATTRIBUTES_CONFIG_KEY = 'mitosis.cart.extra_product_attributes';
     ...
     * @inheritDoc
     */
    public function addItem(Buyable $product, $qty = 1, $params = []): \Mitosis\Cart\Contracts\CartItem
    {
