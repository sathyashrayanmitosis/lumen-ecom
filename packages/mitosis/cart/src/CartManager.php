...
class CartManager implements CartManagerContract
{
    ...
    {
        if (config('mitosis.cart.auto_assign_user') && Auth::check()) {
            $attributes = [
